defmodule App.Commands.Help do
    ...
    /register <api-url> <api-token>
        * Configures the bot for your user to use the <api-url> endpoint with the provided <token>

    /posts <date>
        * Returns the list of available posts. Use the optional <date> parameter to filter the results by date, in the format YYYY-MM-DD. For example, /posts 2019-06 will return all posts from june 2019

    /new <title> \\n <body>
        * Creates a new post with <title> and <body>. Note that there must be a break line between <title> and <body>. Returns the git url of the new post.
